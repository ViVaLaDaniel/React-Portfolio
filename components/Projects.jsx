    ...
    <div className="w-full">
      <div className="max-w-[1240px] mx-auto px-2 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <ProjectItem title="Property Finder" backgroundImg={propertyImg} projectUrl='https://driver-app-react-1.vercel.app/' />
          <ProjectItem title="Service Car" backgroundImg={servicecarImg} projectUrl='https://romaxservice.vercel.app/' />
